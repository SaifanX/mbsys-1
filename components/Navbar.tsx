        ...
        >
          ...
          <div className="hidden md:flex items-center space-x-10">
            ...
            <button
              ...
              className={`p-2.5 rounded-full transition-all duration-300 group ${scrolled ? 'bg-slate-100 dark:bg-slate-800' : 'bg-slate-200/50 dark:bg-white/10'
        ...
        <div className="flex flex-col h-full">
          ...
          <div className="flex-1 overflow-y-auto py-12 px-8">
            <div className="flex flex-col space-y-8">
              {navLinks.map((link) => (
                <a
                  ...
                  href={link.href}
                  onClick={(e) => handleLinkClick(e, link.href)}
                  className={`text-4xl font-display font-bold uppercase tracking-tight transition-all ${currentPath === link.href ? 'text-primary' : 'text-slate-900 dark:text-slate-100'
                    }`}
                >
                  {link.name}
                </a>
            ...
            <div className="mt-16 pt-12 border-t border-slate-100 dark:border-slate-800 space-y-8">
              <p className="font-bold text-2xl text-slate-900 dark:text-white">+91 98863-74122</p>
