    ...
    <div className="pt-40 pb-20 animate-in fade-in slide-in-from-bottom-4 duration-700">
      ...
      {expandedService && (
        <div className="fixed inset-0 z-[200] flex items-center justify-center p-4 lg:p-12">
          ...
          <div className="relative w-full max-w-5xl bg-white dark:bg-surface-dark border border-slate-200 dark:border-slate-800 rounded-lg shadow-2xl overflow-hidden flex flex-col lg:flex-row animate-in zoom-in-95 duration-500 max-h-[90vh]">
            
            <button 
              onClick={() => setExpandedService(null)}
              className="absolute top-4 right-4 z-[210] p-2 bg-slate-900/50 hover:bg-primary text-white backdrop-blur-md rounded-full transition-all border border-white/10"
            ...
            <div className="w-full lg:w-1/2 p-8 lg:p-16 space-y-8 overflow-y-auto custom-scrollbar">
              <div className="space-y-4">
                ...
                <h2 className="text-4xl lg:text-5xl font-display font-bold text-slate-900 dark:text-white tracking-tight leading-none">{expandedService.title}</h2>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 gap-3">
                  {expandedService.features.map((feature, i) => (
                    <div key={i} className="flex items-center gap-4 p-4 bg-slate-50 dark:bg-slate-900/40 border border-slate-100 dark:border-slate-800 rounded-sm">
              ...
              <div className="pt-8 border-t border-slate-100 dark:border-slate-800">
                <button 
                  ...
                  className="w-full py-5 bg-primary text-white font-tech font-bold uppercase tracking-[0.3em] text-sm hover:bg-red-600 transition-all shadow-xl shadow-red-500/20 active:scale-95 flex items-center justify-center gap-4"
                >
                  Request Technical Deployment <ArrowRight size={18} />
                </button>
              </div>
            </div>
          </div>
